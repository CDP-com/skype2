...
function downloadApp()
{
    if ( installApp() )
    {
        location.href = "skype2installer.exe";
    }
...
function helpWithApp()
{
    ...
    // document.location.href = "http://factory.snapback-apps.com/wordpress/wp-content/plugins/autologin-guest/autologin.php?redirect_to=http://factory.snapback-apps.com/wordpress/skype2/wp-admin/post.php%3Fpost=12%26action=edit";
}
