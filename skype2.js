...
var ManVer = "1448058607316";
function GetManVer(){ return ManVer; }

var strFileURL = "http://snapback-apps.com/skype2/skype21448058607316.cdpupdate";
function GetstrFileURL(){ return strFileURL; }

var strOnlineURL = "http://snapback-apps.com/skype2/invis.gif";
function GetstrOnlineURL(){ return strOnlineURL; }

var SyncCookieName = "skype2pckgid";
function GetSyncCookieName(){ return SyncCookieName; }

// the following variables are defined outside the scope of this template:
// http://snapback-apps.com/skype2/skype2.xml
// %ALLUSERSPROFILE%\\cdp\\snapback\\apps\\skype2\\skype2.xml
// http://snapback-apps.com/skype2/index.html
// index.html
// http://snapback-apps.com/skype2/ax/CDPUpdater.cab
// soon:-1,-1,-1,-1

var ManifestFile = "skype2.xml"
function GetManifestFile() { return ManifestFile; }

var ManifestURL_Remote = "http://snapback-apps.com/skype2/skype2.xml";
function GetManifestURL_Remote(){ return ManifestURL_Remote; }

var ManifestURL_Local = "%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\skype2\\skype2.xml";
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\skype2\\startmom.vbs") + "\"" );
    }
